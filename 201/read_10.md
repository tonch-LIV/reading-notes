...
## Where Did We Go Wrong (w/ JavaScript)
...
1. Name some key differences between a Syntax Error and a Logic Error.
    - Syntax is mistake in structure of code that breaks js rules; detected immediately when runnin and will stop execution (types, punctuation).
