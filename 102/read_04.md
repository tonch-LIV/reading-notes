...
1. **Research** - who is the target audience? What is the goal in using your product? who else is doing what you're planning? UX trends (experiment and try new features)
2. **Format research** in easy-to-read manner - make cheat sheets to have on hand and reference regarding business and user goals, user feedback, features, use cases, etc.
3. **Map user flow** - what brings users to your product? how will you provide what they hope to gain/learn? and where will they go afterwards?
4. **Remember, It's a draft** - keep details to a minimum. focus on organizing layout (what is most important and should be seen first), organize different kinds of content (apples to apples, oranges to oranges; unless otherwise needed).
5. **Testing** - pepper in some detail when ready to test and refine taste after trials.
6. **Prototypes** - intermediate phase before final product, content is gradually added and feedback is received from collaborators about experience.
...
4. What is a semantic element?
    - the choosing or naming of an element that is not overly verbose/descriptive in name in relation to its output.
